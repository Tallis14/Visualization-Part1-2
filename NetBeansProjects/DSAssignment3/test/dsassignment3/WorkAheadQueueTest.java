...
System.out.println(e);                assertTrue(e instanceof InvalidArgumentException);
            }
        }
    ...
    public void testEnqueue() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            // firstThrees arrays
            if (i < 3) {  
System.out.println(instance.frontThreeElements.size()+" "+i);         assertEquals(instance.frontThreeElements.size(), i + 1);
                ...
                assertEquals(instance.frontThreeNodes.size(), 3);
                for (int j = 0; j < 3; j++) {
System.out.println(instance.queue.get(j).getElement()+" "+j+1+" ");                    assertEquals(instance.frontThreeElements.get(j).intValue(), 
                                 j + 1);
                    assertEquals(instance.frontThreeNodes.get(j).getElement().
                                 intValue(), j + 1);
                }
...
System.out.println(instance.size()+""+(max-i-1));                assertEquals(instance.size(), max - 1 - i);
